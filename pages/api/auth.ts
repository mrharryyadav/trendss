...
export async function accessGoogleSheet(values:Array<[]>) {
...
const spreadsheetId = '10OPcUhBnty8e5pxDd9hgkn4DSvWgb8bVNQoxImcNqBo';
  ...
  sheets.spreadsheets.values.append(
    {
      ...
      range: 'A1', // Update the range accordingly
  ...
  //   auth: client,
  //   spreadsheetId: spreadsheetId,
  //   range: '!A1:Z1000', // Specify the range you want to fetch
  // }, (err:any, res:any) => {
  //   if (err) return console.log(`The API returned an error: ${err}`);
  //   const values = res.data.values;
  //   // console.log('Data from Google Sheet:', res.data);
  // });


  // console.log("auth", sheets)
